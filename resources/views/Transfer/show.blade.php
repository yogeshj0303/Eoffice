            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        <input type="text" id="name" name="user_id" class="form-control readonly-input" value="{{ $transfer->user_id }}" readonly>
                    </div>
                    <div class="col-md-3">
...
<!--</div>-->
                ...
                <div style="display: flex; justify-content: flex-end; gap: 10px;">
                    <div class="hstack gap-2">
                        <button class="btn btn-primary" onclick="window.location.href='{{ route('transfer.index')}}'">Back</button>
                    </div>
                </div>            
            </div><!-- end card body -->
        </div><!-- end card -->
