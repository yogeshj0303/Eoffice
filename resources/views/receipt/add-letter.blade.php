...
<div class="elebtn" style="display: flex; align-items: center; gap: 10px;">
    ...
    <input type="file" id="fileInput" name="letter_content" accept="application/pdf" style="display: none;" />
            ...
            <iframe id="pdfViewer" style="width:100%; height:500px; display:none;" frameborder="0" ></iframe>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="summernote" name="letter_content" class="form-control" > {!!$letter->letter_content!!}</textarea>
                                </div>
                            </div>
    ...
    ->first();?>
                        ...
                        <input type="text" id="taluka" name="taluka" class="form-control" value="{{$user_data->th_name}}" readonly>
                    </div>
    ...
    <div class="row">
        <div class="col-md-12 mb-3">
            ...
            <!-- Approve Button -->
              <button type="button" id="send-button" class="btn btn-primary me-2" data-docuser="{{$letter->id}}" data-bs-toggle="modal" data-bs-target="#ForwardModel">Send</button>
