                ...
                <button class="btn btn-info btn-sm view-description" 
                    ...
                    <i class="fas fa-eye"></i>
                                ...
                                <?php $usernameFrwd = DB::table('users')->where('id',$receipt->frwd_hod_id)->first(); ?>
                                    <td>{{ $usernameFrwd ? $usernameFrwd->first_name : 'N/A' }}</td>
                                                                        <td class="status">
                                ...
                                </div>@elseif($receipt->status == 'rejected' && $receipt->frwd_hod_id == null )  <div class="checkmark-container">
                                    <!-- Signed info text -->
...
@if($receipt->status != 'rejected' && $receipt->status != 'approved' )
