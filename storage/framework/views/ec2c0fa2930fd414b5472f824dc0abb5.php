...
<table class="info-table">
    <?php $rowNumber = 1; ?> <!-- Initialize the counter -->

    <tr class="table-row">
        <td class="table-cell"><?php echo e($rowNumber++); ?></td> <!-- Display and increment counter -->
        <td class="table-cell">Name</td>
        <td class="table-cell"><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></td>
    </tr>
  <?php if(!empty($user->email)): ?>
    ...
    <?php if(!empty($user->number)): ?>
        <tr class="table-row">
            <td class="table-cell"><?php echo e($rowNumber++); ?></td>
            <td class="table-cell">Contact No</td>
            <td class="table-cell"><?php echo e($user->number); ?></td>
        </tr>
    <?php endif; ?>
    ...
    <?php if(!empty($user->state)): ?>
        <tr class="table-row">
            ...
            <td class="table-cell"><?php echo e($user->state); ?></td>
        </tr>
    <?php endif; ?>
    ...
    <?php if(!empty($user->district)): ?>
        <tr class="table-row">
            ...
            <td class="table-cell"><?php echo e($user->district); ?></td>
        </tr>
    <?php endif; ?>

    <?php if(!empty($user->taluka)): ?>
        <tr class="table-row">
            <td class="table-cell"><?php echo e($rowNumber++); ?></td>
            <td class="table-cell">Taluka</td>
            <td class="table-cell"><?php echo e($user->taluka); ?></td>
        </tr>
    <?php endif; ?>
            ...
            <tr class="table-row">
                ...
                <td class="table-cell"><?php echo e($user->org_name); ?></td>
            </tr>
            <?php endif; ?>
            ...
            <tr class="table-row">
                ...
                <td class="table-cell"><?php echo e($user->department_name); ?></td>
            </tr>
            <?php endif; ?>

            <?php if(!empty($user->designation_name)): ?>
            <tr class="table-row">
                <td class="table-cell"><?php echo e($rowNumber++); ?></td>
                <td class="table-cell">Designation Name</td>
                <td class="table-cell"><?php echo e($user->designation_name); ?></td>
            </tr>
            <?php endif; ?>

            <?php if(!empty($user->joining_start_salary)): ?>
            <tr class="table-row">
                <td class="table-cell"><?php echo e($rowNumber++); ?></td>
                <td class="table-cell">Joining Start Salary</td>
                <td class="table-cell"><?php echo e($user->joining_start_salary); ?></td>
            </tr>
            <?php endif; ?>
    ...
    <?php if(!empty($user->after_mar_first_name)): ?>
        <tr class="table-row">
            ...
            <td class="table-cell"><?php echo e($user->after_mar_first_name); ?></td>
        </tr>
    <?php endif; ?>

    <?php if(!empty($user->after_mar_mid_name)): ?>
        <tr class="table-row">
            <td class="table-cell"><?php echo e($rowNumber++); ?></td>
            <td class="table-cell">After Marriage Middle Name</td>
            <td class="table-cell"><?php echo e($user->after_mar_mid_name); ?></td>
        </tr>
    <?php endif; ?>

    <?php if(!empty($user->after_mar_last_name)): ?>
        <tr class="table-row">
            <td class="table-cell"><?php echo e($rowNumber++); ?></td>
            <td class="table-cell">After Marriage Last Name</td>
            <td class="table-cell"><?php echo e($user->after_mar_last_name); ?></td>
        </tr>
    <?php endif; ?>

    <?php if(!empty($user->address_B)): ?>
        <tr class="table-row">
            <td class="table-cell"><?php echo e($rowNumber++); ?></td>
    ...
    <?php if(!empty($user->father_address)): ?>
        <tr class="table-row">
            <td class="table-cell"><?php echo e($rowNumber++); ?></td>
    ...
    <?php if(!empty($user->another_qualification)): ?>
        <tr class="table-row">
            <td class="table-cell"><?php echo e($rowNumber++); ?></td>
    ...
    <?php endif; ?>
        ...
        <div class="signature-section">
            <div class="signature">
                <img src="<?php echo e(asset('checkmark.png')); ?>" alt="Clerk Signature">
                
                <p>Clerk Signature</p>
            </div>
            <div class="signature">
                <img src="<?php echo e(asset('checkmark.png')); ?>" alt="HOD Signature">
                <p>HOD Signature </p>
            </div>
        </div>
